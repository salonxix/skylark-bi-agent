...
export async function GET() {
  try {
    ...
    const snapshot = await client.fetchBoardSnapshot(config.dealsBoardId);
    ...
    const message = error instanceof Error ? error.message : 'An unexpected error occurred while fetching Deals board';
